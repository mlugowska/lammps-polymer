...
add_branch = True
if add_branch:
    FILENAME = f"../data/N{vars.N_ATOMS}_{vars.N_ATOM_IN_BRANCH}_in_branch_{vars.N_ATOMS_TOTAL}_total/N{vars.N_ATOMS_TOTAL}_shrinking.in"
else:
    FILENAME = f"../data/N{vars.N_ATOMS}/N{vars.N_ATOMS}_shrinking.in"
...
with open(FILENAME, "w") as file:
    ...
    file.write("dump         1 all custom {vars.DUMP_STEP} shrinking.lammpsdump id mol type x y z\n")
    file.write("dump_modify  1  sort id\n")
    file.write("restart      50000 shrinked.restart\n")
